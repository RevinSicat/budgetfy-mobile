...
class AccountCard extends ConsumerWidget {
    ...
    Widget build(BuildContext context, WidgetRef ref) {
        ...
        final uuidLast4 = account.id.toString().substring(account.id.length - 4);
        ...
        return Container(
            ...
            child: Column(
                ...
                children: [
                // Top row: account name (start) + EMV chip (end)
                Row(
                ...
                // Middle row: balance aligned to end
                Row(
                ...
                // Bottom row: UUID last 4 digits aligned to start
                Row(
